...
npx create-solana-dapp --template gh:solana-developers/solana-templates/templates/legacy-voting-dapp
# created an pnpm based project
pnpx create-solana-dapp --template gh:solana-developers/solana-templates/templates/legacy-voting-dapp
# created an yarn based project
yarn create solana-dapp --template gh:solana-developers/solana-templates/templates/legacy-voting-dapp
```
...
cd solana-templates/legacy-voting-dapp
```
